!function (e, t) {
    ...
    function t(e, n) {
        e = e || {};
        for (var i in n)
            n[i] && n[i].constructor && n[i].constructor === Object ? (e[i] = e[i] || {},
                t(e[i], n[i])) : e[i] = n[i];
        return e
    }
    function n(e, t, n) {
    ...
    function s(e, t) {
        ...
        return i.src === e ? n = new Promise(function (e) {
            ...
            "http" === e.substring(0, 4).toLowerCase() && i.setAttribute("crossOrigin", "anonymous"),
                i.onload = function () {
                    setTimeout(function () {
                        t(i)
                    }, 1)
    ...
    function c() {
        var e, t, n, i, a = this, s = "croppie-container", l = a.options.viewport.type ? "cr-vp-" + a.options.viewport.type : null;
        a.options.useCanvas = a.options.enableOrientation || p.call(a),
            a.data = {},
            a.elements = {},
            ...
            a.options.useCanvas ? (a.elements.canvas = document.createElement("canvas"),
                a.elements.preview = a.elements.canvas) : a.elements.preview = a.elements.img,
            r(e, "cr-boundary"),
            o(e, {
            ...
            e.appendChild(i),
            r(a.element, s),
            a.options.customClass && r(a.element, a.options.customClass),
            g.call(this),
            a.options.enableZoom && d.call(a)
    }
    function p() {
    ...
    function m(e) {
        ...
        if (n._currentZoom = e ? e.value : n._currentZoom,
            ...
            var s = f.call(n, r)
                , l = s.translate
                , u = s.origin;
            i.x >= l.maxX && (a.x = u.minX,
                i.x = l.maxX),
                i.x <= l.minX && (a.x = u.maxX,
                    i.x = l.minX),
                i.y >= l.maxY && (a.y = u.minY,
                    i.y = l.maxY),
                i.y <= l.minY && (a.y = u.maxY,
                    i.y = l.minY)
        }
        t(),
            D.call(n),
    ...
    function g() {
        function e(e, t) {
            var n = m.elements.preview.getBoundingClientRect()
                , i = d.y + t
                , o = d.x + e;
            m.options.enforceBoundary ? (p.top > n.top + t && p.bottom < n.bottom + t && (d.y = i),
                p.left > n.left + e && p.right < n.right + e && (d.x = o)) : (d.y = i,
                    d.x = o)
        }
        function t(e) {
            function t(e) {
            ...
            if (!e.shiftKey || e.keyCode != o && e.keyCode != a) {
                if (e.keyCode >= 37 && e.keyCode <= 40) {
                    e.preventDefault();
                    var s = t(e.keyCode);
                    d = H.parse(m.elements.preview),
                        document.body.style[z] = "none",
                        p = m.elements.viewport.getBoundingClientRect(),
                        n(s)
                }
            } else {
                var l = 0;
                l = e.keyCode == o ? parseFloat(m.elements.zoomer.value, 10) + parseFloat(m.elements.zoomer.step, 10) : parseFloat(m.elements.zoomer.value, 10) - parseFloat(m.elements.zoomer.step, 10),
                    m.setZoom(l)
            }
        }
        function n(t) {
            ...
            e(n, i),
                r[k] = d.toString(),
                o(m.elements.preview, r),
                w.call(m),
                document.body.style[z] = "",
                v.call(m),
                y.call(m),
                c = 0
        }
        ...
        function a(t) {
            ...
            if ("touchmove" == t.type && t.touches.length > 1) {
                ...
                var b = y / c;
                return h.call(m, b),
                    void i(m.elements.zoomer)
            }
            e(s, p),
                f[k] = d.toString(),
                o(m.elements.preview, f),
                w.call(m),
                u = r,
                l = n
        }
        ...
        var l, u, c, p, d, m = this, f = !1;
        m.elements.overlay.addEventListener("mousedown", r),
            m.elements.viewport.addEventListener("keydown", t),
            m.elements.overlay.addEventListener("touchstart", r)
    }
    function w() {
        var e = this
    ...
    function x() {
        var e, t, n, r, a, s = this, l = 0, u = 1.5, c = 1, p = {}, d = s.elements.preview, m = s.elements.zoomer, f = new H(0, 0, c), g = new T, y = b.call(s);
        if (y && !s.data.bound) {
            if (s.data.bound = !0,
                p[k] = f.toString(),
                p[j] = g.toString(),
                ...
                t = s.elements.viewport.getBoundingClientRect(),
                n = s.elements.boundary.getBoundingClientRect(),
                s._originalImageWidth = e.width,
                s._originalImageHeight = e.height,
                s.options.enableZoom) {
                s.options.enforceBoundary && (r = t.width / e.width,
                    a = t.height / e.height,
                    l = Math.max(r, a)),
                    l >= u && (u = l + 1),
                    m.min = B(l, 4),
                ...
                c = null !== s.data.boundZoom ? s.data.boundZoom : x,
                    h.call(s, c),
                    i(m)
            } else
                s._currentZoom = c;
            f.scale = s._currentZoom,
                p[k] = f.toString(),
                o(d, p),
                s.data.points.length ? C.call(s, s.data.points) : E.call(s),
                v.call(s),
                w.call(s)
        }
    }
    function C(e) {
        ...
        var t = this
            ...
            , d = {};
        d[j] = u + "px " + l + "px",
            d[k] = new H(p, c, s).toString(),
            o(t.elements.preview, d),
            h.call(t, s),
            t._currentZoom = s
    }
    function E() {
    ...
    function I(e, t) {
        var n = t.points
            ...
            , c = r
            , p = a;
        return t.outputWidth && t.outputHeight && (c = t.outputWidth,
            p = t.outputHeight),
            l.width = c,
            l.height = p,
            t.backgroundColor && (u.fillStyle = t.backgroundColor,
                u.fillRect(0, 0, c, p)),
            u.drawImage(e, i, o, r, a, 0, 0, c, p),
            s && (u.fillStyle = "#fff",
                u.globalCompositeOperation = "destination-in",
                u.beginPath(),
                u.arc(c / 2, p / 2, c / 2, 0, 2 * Math.PI, !0),
                u.closePath(),
                u.fill()),
            l.toDataURL(t.format, t.quality)
    }
    function Z(e, t) {
        var n, i = this, o = [], r = null;
        if ("string" == typeof e)
            n = e,
                e = {};
        ...
        i.data.bound = !1,
            ...
            i.data.points = (o || i.data.points).map(function (e) {
                return parseFloat(e)
            }),
            i.data.boundZoom = r;
        var a = s(n, i.elements.img);
        return a.then(function () {
            i.options.useCanvas && (i.elements.img.exifdata = null,
                _.call(i, e.orientation || 1)),
                x.call(i),
                y.call(i),
                t && t()
        }),
    ...
    function L(e) {
        var n, i = this, o = F.call(i), r = t(N, t({}, e)), a = "string" == typeof e ? e : r.type || "viewport", s = r.size, l = r.format, u = r.quality, c = r.backgroundColor, p = "boolean" == typeof r.circle ? r.circle : "circle" === i.options.viewport.type, h = i.elements.viewport.getBoundingClientRect(), d = h.width / h.height;
        return "viewport" === s ? (o.outputWidth = h.width,
            o.outputHeight = h.height) : "object" == typeof s && (s.width && s.height ? (o.outputWidth = s.width,
                o.outputHeight = s.height) : s.width ? (o.outputWidth = s.width,
                    o.outputHeight = s.width / d) : s.height && (o.outputWidth = s.height * d,
                        o.outputHeight = s.height)),
            q.indexOf(l) > -1 && (o.format = "image/" + l,
                o.quality = u),
            o.circle = p,
            o.url = i.data.url,
            o.backgroundColor = c,
    ...
    var j, k, z, P = ["Webkit", "Moz", "ms"], W = document.createElement("div").style;
    k = e("transform"),
        j = e("transformOrigin"),
        z = e("userSelect");
    var O = "translate3d"
    ...
    H.parse = function (e) {
        ...
        H.fromMatrix = function (e) {
            ...
            return t.length && "none" !== e || (t = [1, 0, 0, 1, 0, 0]),
                new H(parseInt(t[4], 10), parseInt(t[5], 10), parseFloat(t[0]))
        }
        ,
            ...
            if ("string" === t) {
                ...
                return "get" === e ? i.get() : "result" === e ? i.result.apply(i, n) : "bind" === e ? i.bind.apply(i, n) : this.each(function () {
                    ...
                    if (t) {
                        ...
                        i.apply(t, n),
                            "destroy" === e && $(this).removeData("croppie")
                    }
                })
            }
    ...
    S.defaults = {
        ...
        exports.Croppie = window.Croppie = S,

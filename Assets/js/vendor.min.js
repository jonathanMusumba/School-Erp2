!function(e, t) {
    ...
    _.extend = _.fn.extend = function() {
        ...
        a--); a < l; a++)
            if (null != (e = arguments[a]))
                for (t in e)
                    n = s[t],
                    s !== (i = e[t]) && (u && i && (_.isPlainObject(i) || (r = Array.isArray(i))) ? (r ? (r = !1,
                    o = n && Array.isArray(n) ? n : []) : o = n && _.isPlainObject(n) ? n : {},
                    s[t] = _.extend(u, o, i)) : void 0 !== i && (s[t] = i));
        return s
    }
    ,
    _.extend({
        ...
        makeArray: function(e, t) {
            var n = t || [];
            return null != e && (T(Object(e)) ? _.merge(n, "string" == typeof e ? [e] : e) : a.call(n, e)),
            n
        },
    ...
    var x = function(e) {
        var t, n, i, r, o, s, a, l, u, c, f, d, h, p, g, m, v, y, b, w = "sizzle" + 1 * new Date, _ = e.document, E = 0, T = 0, x = se(), C = se(), S = se(), A = function(e, t) {
            return e === t && (f = !0),
            0
        }, D = {}.hasOwnProperty, N = [], I = N.pop, O = N.push, k = N.push, L = N.slice, j = function(e, t) {
            for (var n = 0, i = e.length; n < i; n++)
                if (e[n] === t)
                    return n;
            return -1
        }, P = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", H = "[\\x20\\t\\r\\n\\f]", q = "(?:\\\\.|[\\w-]|[^\0-\\xa0])+", M = "\\[" + H + "*(" + q + ")(?:" + H + "*([*^$|!~]?=)" + H + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + q + "))|)" + H + "*\\]", R = ":(" + q + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + M + ")*)|.*)\\)|)", W = new RegExp(H + "+","g"), F = new RegExp("^" + H + "+|((?:^|[^\\\\])(?:\\\\.)*)" + H + "+$","g"), B = new RegExp("^" + H + "*," + H + "*"), U = new RegExp("^" + H + "*([>+~]|" + H + ")" + H + "*"), V = new RegExp("=" + H + "*([^\\]'\"]*?)" + H + "*\\]","g"), K = new RegExp(R), Q = new RegExp("^" + q + "$"), z = {
            ID: new RegExp("^#(" + q + ")"),
            CLASS: new RegExp("^\\.(" + q + ")"),
            TAG: new RegExp("^(" + q + "|[*])"),
            ATTR: new RegExp("^" + M),
        ...
        }, $ = /^(?:input|select|textarea|button)$/i, Y = /^h\d$/i, G = /^[^{]+\{\s*\[native \w/, X = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, J = /[+~]/, Z = new RegExp("\\\\([\\da-f]{1,6}" + H + "?|(" + H + ")|.)","ig"), ee = function(e, t, n) {
            var i = "0x" + t - 65536;
        ...
        try {
            k.apply(N = L.call(_.childNodes), _.childNodes),
        ...
        function oe(e, t, i, r) {
            ...
            "string" != typeof e || !e || 1 !== E && 9 !== E && 11 !== E)
                return i;
            if (!r && ((t ? t.ownerDocument || t : _) !== h && d(t),
            t = t || h,
            g)) {
                if (11 !== E && (f = X.exec(e)))
                    if (o = f[1]) {
                        ...
                        if ((o = f[3]) && n.getElementsByClassName && t.getElementsByClassName)
                            return k.apply(i, t.getElementsByClassName(o)),
                            i
                    }
                if (n.qsa && !S[e + " "] && (!m || !m.test(e))) {
                    ...
                    if (v)
                        try {
                            return k.apply(i, y.querySelectorAll(v)),
                            i
                        } catch (e) {} finally {
        ...
        d = oe.setDocument = function(e) {
            ...
            : function(e, t) {
                ...
                if (!r || !o)
                    return e === h ? -1 : t === h ? 1 : r ? -1 : o ? 1 : c ? j(c, e) - j(c, t) : 0;
                if (r === o)
                    return ce(e, t);
                ...
                CHILD: function(e, t, n, i, r) {
                    ...
                    : function(t, n, l) {
                        ...
                        if (m) {
                            ...
                            s && y) {
                                for (b = (h = (u = (c = (f = (d = m)[w] || (d[w] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] || [])[0] === E && u[1]) && u[2],
                                d = h && m.childNodes[h]; d = ++h && d && d[g] || (b = h = 0) || p.pop(); )
                                    if (1 === d.nodeType && ++b && d === t) {
                                        c[e] = [E, h, b];
                                        break
                                    }
                            } else if (y && (b = h = (u = (c = (f = (d = t)[w] || (d[w] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] || [])[0] === E && u[1]),
                            !1 === b)
                                for (; (d = ++h && d && d[g] || (b = h = 0) || p.pop()) && ((a ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++b || (y && ((c = (f = d[w] || (d[w] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] = [E, b]),
                                d !== t)); )
                                    ;
            ...
            ae(function(o, s, a, l) {
                var u, c, f, d = [], h = [], p = s.length, g = o || function(e, t, n) {
                    for (var i = 0, r = t.length; i < r; i++)
                        oe(e, t[i], n);
                    return n
                }(t || "*", a.nodeType ? [a] : a, []), m = !e || !o && t ? g : we(g, d, e, a, l), v = n ? r || (o ? e : p || i) ? [] : s : m;
                if (n && n(m, v, a, l),
                i)
                    for (u = we(v, h),
                    i(u, [], a, l),
                ...
                if (o) {
                    if (r || e) {
                        ...
                        for (c = v.length; c--; )
                            (f = v[c]) && (u = r ? j(o, f) : d[c]) > -1 && (o[u] = !(s[u] = f))
                    }
                } else
                    v = we(v === s ? v.splice(p, v.length) : v),
                    r ? r(null, s, v, l) : k.apply(s, v)
            })
        }
        function Ee(e) {
        ...
        a = oe.compile = function(e, t) {
            ...
            if (!m) {
                for (t || (t = s(e)),
                n = t.length; n--; )
                    (m = Ee(t[n]))[w] ? f.push(m) : p.push(m);
                (m = S(e, (r = p,
                a = (o = f).length > 0,
                l = r.length > 0,
                c = function(e, t, n, s, c) {
                    var f, p, m, v = 0, y = "0", b = e && [], w = [], _ = u, T = e || l && i.find.TAG("*", c), x = E += null == _ ? 1 : Math.random() || .1, C = T.length;
                    ...
                    a && y !== v) {
                        ...
                        if (e) {
                            if (v > 0)
                                for (; y--; )
                                    b[y] || w[y] || (w[y] = I.call(s));
                            w = we(w)
                        }
                        k.apply(s, w),
                        c && !e && w.length > 0 && v + o.length > 1 && oe.uniqueSort(s)
                    }
                    return c && (E = x,
                    u = _),
                    b
        ...
        l = oe.select = function(e, t, n, r) {
            ...
            return (d || a(e, h))(r, t, !g, n, !t || J.test(e) && ge(t.parentNode) || t),
            n
        }
        ,
    ...
    (_.fn.init = function(e, t, n) {
        ...
        if (n = n || O,
        "string" == typeof e) {
            if (!(r = "<" === e[0] && ">" === e[e.length - 1] && e.length >= 3 ? [null, e, null] : k.exec(e)) || !r[1] && t)
                ...
                then: function(t, i, r) {
                    ...
                    function s(t, n, i, r) {
                        return function() {
                            var a = this
                              ...
                              , u = function() {
                                ...
                                if (!(t < o)) {
                                    ...
                                    g(u) ? r ? u.call(e, s(o, n, q, r), s(o, n, M, r)) : (o++,
                                    u.call(e, s(o, n, q, r), s(o, n, M, r), s(o, n, q, n.notifyWith))) : (i !== q && (a = void 0,
                                    l = [e]),
                                    (r || n.resolveWith)(a, l))
                                }
                            }
                            ...
                            ;
                            t ? c() : (_.Deferred.getStackHook && (c.stackTrace = _.Deferred.getStackHook()),
                            e.setTimeout(c))
                        }
                    }
    ...
    _.ready.then = F.then,
    "complete" === i.readyState || "loading" !== i.readyState && !i.documentElement.doScroll ? e.setTimeout(_.ready) : (i.addEventListener("DOMContentLoaded", B),
        ...
        data: function(e, t) {
            ...
            if (void 0 === e) {
                ...
                1 === o.nodeType && !G.get(o, "hasDataAttrs"))) {
                    for (n = s.length; n--; )
                        s[n] && 0 === (i = s[n].name).indexOf("data-") && (i = z(i.slice(5)),
                        ee(o, i, r[i]));
            ...
            return "object" == typeof e ? this.each(function() {
                ...
                var n;
                if (o && void 0 === t)
                    return void 0 !== (n = X.get(o, e)) ? n : void 0 !== (n = ee(o, e)) ? n : void 0;
                this.each(function() {
                    X.set(this, e, t)
                })
    ...
    _.extend({
        queue: function(e, t, n) {
            ...
            if (e)
                return t = (t || "fx") + "queue",
                i = G.get(e, t),
                n && (!i || Array.isArray(n) ? i = G.access(e, t, _.makeArray(n)) : i.push(n)),
                i || []
        },
    ...
    function se(e, t, n, i) {
        ...
        , l = a(), u = n && n[3] || (_.cssNumber[t] ? "" : "px"), c = (_.cssNumber[t] || "px" !== u && +l) && ne.exec(_.css(e, t));
        if (c && c[3] !== u) {
            for (l /= 2,
            u = u || c[3],
            c = +l || 1; s--; )
    ...
    function le(e, t) {
        for (var n, i, r, o, s, a, l, u = [], c = 0, f = e.length; c < f; c++)
            ...
            t ? ("none" === n && (u[c] = G.get(i, "display") || null,
            u[c] || (i.style.display = "")),
            "" === i.style.display && re(i) && (u[c] = (o = void 0,
            s = void 0,
            void 0,
            l = void 0,
            s = (r = i).ownerDocument,
    ...
    function ye(e, t, n, i, r) {
        ...
        h = 0; o = d[h++]; )
            if (i && _.inArray(o, i) > -1)
                r && r.push(o);
            else if (u = _.contains(o.ownerDocument, o),
    ...
    _.event = {
            ...
            if (m && (l = m.events)) {
                for (u = (t = (t || "").match(H) || [""]).length; u--; )
                    ...
                    h) {
                        ...
                        s && !d.length && (f.teardown && !1 !== f.teardown.call(e, p, m.handle) || _.removeEvent(e, h, m.handle),
                        delete l[h])
                    } else
                        for (h in l)
        ...
        dispatch: function(e) {
            var t, n, i, r, o, s, a = _.event.fix(e), l = new Array(arguments.length), u = (G.get(this, "events") || {})[a.type] || [], c = _.event.special[a.type] || {};
            for (l[0] = a,
            ...
            if (l && u.nodeType && !("click" === e.type && e.button >= 1))
                for (; u !== this; u = u.parentNode || this)
                    if (1 === u.nodeType && ("click" !== e.type || !0 !== u.disabled)) {
                        ...
                        s = {},
                        n = 0; n < l; n++)
                            void 0 === s[r = (i = t[n]).selector + " "] && (s[r] = i.needsContext ? _(r, this).index(u) > -1 : _.find(r, this, null, [u]).length),
                            s[r] && o.push(i);
                        o.length && a.push({
                            elem: u,
                            handlers: o
    ...
    function Pe(e, t, n, i) {
        t = s.apply([], t);
        var r, o, a, l, u, c, f = 0, d = e.length, h = d - 1, m = t[0], v = g(m);
        if (v || d > 1 && "string" == typeof m && !p.checkClone && Ne.test(m))
            return e.each(function(r) {
                var o = e.eq(r);
                v && (t[0] = m.call(this, r, o.html())),
                Pe(o, t, n, i)
            });
        if (d && (o = (r = ye(t, e[0].ownerDocument, !1, e, i)).firstChild,
        1 === r.childNodes.length && (r = o),
        o || i)) {
            for (l = (a = _.map(he(r, "script"), ke)).length; f < d; f++)
                u = r,
                f !== h && (u = _.clone(u, !0, !0),
                l && _.merge(a, he(u, "script"))),
                n.call(e[f], u, f);
            if (l)
                ...
                f = 0; f < l; f++)
                    u = a[f],
                    fe.test(u.type || "") && !G.access(u, "globalEval") && _.contains(c, u) && (u.src && "module" !== (u.type || "").toLowerCase() ? _._evalUrl && _._evalUrl(u.src) : y(u.textContent.replace(Ie, ""), c, u))
        }
        return e
    }
    function He(e, t, n) {
        for (var i, r = t ? _.filter(t, e) : e, o = 0; null != (i = r[o]); o++)
            n || 1 !== i.nodeType || _.cleanData(he(i)),
            i.parentNode && (n && _.contains(i.ownerDocument, i) && pe(he(i, "script")),
    ...
    _.extend({
        ...
        clone: function(e, t, n) {
            var i, r, o, s, a, l, u, c = e.cloneNode(!0), f = _.contains(e.ownerDocument, e);
            ...
            if (t)
                if (n)
                    ...
                    je(e, c);
            return (s = he(c, "script")).length > 0 && pe(s, !f && he(e, "script")),
            c
        },
    ...
    _.fn.extend({
        ...
        empty: function() {
            for (var e, t = 0; null != (e = this[t]); t++)
                1 === e.nodeType && (_.cleanData(he(e, !1)),
                e.textContent = "");
            return this
        },
        clone: function(e, t) {
        ...
        html: function(e) {
            return U(this, function(e) {
                ...
                if ("string" == typeof e && !De.test(e) && !de[(ce.exec(e) || ["", ""])[1].toLowerCase()]) {
                    ...
                    try {
                        for (; n < i; n++)
                            1 === (t = this[n] || {}).nodeType && (_.cleanData(he(t, !1)),
                            t.innerHTML = e);
                        t = 0
                    } catch (e) {}
                }
        ...
        replaceWith: function() {
            ...
            return Pe(this, arguments, function(t) {
                ...
                _.inArray(this, e) < 0 && (_.cleanData(he(this)),
    ...
    function We(e, t, n) {
        ...
        !p.pixelBoxStyles() && qe.test(s) && Re.test(t) && (i = a.width,
        r = a.minWidth,
        o = a.maxWidth,
    ...
    function Ge(e, t, n, i, r, o) {
        ...
        if (n === (i ? "border" : "content"))
            return 0;
        for (; s < 4; s += 2)
            "margin" === n && (l += _.css(e, n + ie[s], !0, r)),
            i ? ("content" === n && (l -= _.css(e, "padding" + ie[s], !0, r)),
            "margin" !== n && (l -= _.css(e, "border" + ie[s] + "Width", !0, r))) : (l += _.css(e, "padding" + ie[s], !0, r),
            "padding" !== n ? l += _.css(e, "border" + ie[s] + "Width", !0, r) : a += _.css(e, "border" + ie[s] + "Width", !0, r));
    ...
    _.extend({
        ...
        style: function(e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var r, o, s, a = z(t), l = Ue.test(t), u = e.style;
                if (l || (t = $e(a)),
    ...
    _.each(["height", "width"], function(e, t) {
        _.cssHooks[t] = {
            get: function(e, n, i) {
                if (n)
                    return !Be.test(_.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? Xe(e, t, i) : oe(e, Ve, function() {
                        return Xe(e, t, i)
                    })
            },
            set: function(e, n, i) {
                var r, o = Me(e), s = "border-box" === _.css(e, "boxSizing", !1, o), a = i && Ge(e, t, i, s, o);
                return s && p.scrollboxSize() === o.position && (a -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(o[t]) - Ge(e, t, "border", !1, o) - .5)),
                a && (r = ne.exec(n)) && "px" !== (r[3] || "px") && (e.style[t] = n,
                n = _.css(e, t)),
                Ye(0, n, a)
            }
        }
    ...
    function ot() {
        et && (!1 === i.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(ot) : e.setTimeout(ot, _.fx.interval),
        _.fx.tick())
    }
    function st() {
    ...
    function ut(e, t, n) {
        var i, r, o = 0, s = ut.prefilters.length, a = _.Deferred().always(function() {
            delete l.elem
        }), l = function() {
            if (r)
                return !1;
            for (var t = Ze || st(), n = Math.max(0, u.startTime + u.duration - t), i = 1 - (n / u.duration || 0), o = 0, s = u.tweens.length; o < s; o++)
                u.tweens[o].run(i);
        ...
        for (!function(e, t) {
            ...
            if (i = ut.prefilters[o].call(u, e, c, u.opts))
                return g(i.stop) && (_._queueHooks(u.elem, u.opts.queue).stop = i.stop.bind(i)),
                i;
        return _.map(c, lt, u),
    ...
    _.Animation = _.extend(ut, {
        ...
        prefilters: [function(e, t, n) {
            var i, r, o, s, a, l, u, c, f = "width"in t || "height"in t, d = this, h = {}, p = e.style, g = e.nodeType && re(e), m = G.get(e, "fxshow");
            ...
            if ((l = !_.isEmptyObject(t)) || !_.isEmptyObject(h))
                ...
                "none" === (c = _.css(e, "display")) && (u ? c = u : (le([e], !0),
                u = e.style.display || u,
                c = _.css(e, "display"),
                le([e]))),
                ("inline" === c || "inline-block" === c && null != u) && "none" === _.css(e, "float") && (l || (d.done(function() {
                    p.display = u
                }),
                null == u && (c = p.display,
                u = "none" === c ? "" : c)),
    ...
    _.fn.extend({
        ...
        finish: function(e) {
            return !1 !== e && (e = e || "fx"),
            this.each(function() {
                var t, n = G.get(this), i = n[e + "queue"], r = n[e + "queueHooks"], o = _.timers, s = i ? i.length : 0;
                for (n.finish = !0,
                _.queue(this, e, []),
    ...
    _.extend({
        attr: function(e, t, n) {
            ...
            if (3 !== o && 8 !== o && 2 !== o)
                return void 0 === e.getAttribute ? _.prop(e, t, n) : (1 === o && _.isXMLDoc(e) || (r = _.attrHooks[t.toLowerCase()] || (_.expr.match.bool.test(t) ? ct : void 0)),
    ...
    _.extend(_.event, {
        trigger: function(t, n, r, o) {
            var s, a, l, u, c, d, h, p, v = [r || i], y = f.call(t, "type") ? t.type : t, b = f.call(t, "namespace") ? t.namespace.split(".") : [];
            if (a = p = l = r = r || i,
            3 !== r.nodeType && 8 !== r.nodeType && !yt.test(y + _.event.triggered) && (y.indexOf(".") > -1 && (y = (b = y.split(".")).shift(),
            b.sort()),
            c = y.indexOf(":") < 0 && "on" + y,
            ...
            o || !h.trigger || !1 !== h.trigger.apply(r, n))) {
                ...
                for (s = 0; (a = v[s++]) && !t.isPropagationStopped(); )
                    ...
                    (d = (G.get(a, "events") || {})[t.type] && G.get(a, "handle")) && d.apply(a, n),
                    (d = c && a[c]) && d.apply && $(a) && (t.result = d.apply(a, n),
                    !1 === t.result && t.preventDefault());
                return t.type = y,
                o || t.isDefaultPrevented() || h._default && !1 !== h._default.apply(v.pop(), n) || !$(r) || c && g(r[y]) && !m(r) && ((l = r[c]) && (r[c] = null),
                _.event.triggered = y,
    ...
    _.extend({
        ...
        ajax: function(t, n) {
            ...
            t = void 0),
            n = n || {};
            var r, o, s, a, l, u, c, f, d, h, p = _.ajaxSetup({}, n), g = p.context || p, m = p.context && (g.nodeType || g.jquery) ? _(g) : _.event, v = _.Deferred(), y = _.Callbacks("once memory"), b = p.statusCode || {}, w = {}, E = {}, T = "canceled", x = {
                readyState: 0,
            ...
            if (v.promise(x),
            p.url = ((t || p.url || wt.href) + "").replace(Lt, wt.protocol + "//"),
            ...
            c)
                return x;
            for (d in (f = _.event && p.global) && 0 == _.active++ && _.event.trigger("ajaxStart"),
            ...
            delete p.data),
            !1 === p.cache && (o = o.replace(It, "$1"),
            h = (Et.test(o) ? "&" : "?") + "_=" + _t++ + h),
            p.url = o + h),
            p.ifModified && (_.lastModified[o] && x.setRequestHeader("If-Modified-Since", _.lastModified[o]),
            _.etag[o] && x.setRequestHeader("If-None-Match", _.etag[o])),
            ...
            function C(t, n, i, a) {
                ...
                u ? (p.ifModified && ((E = x.getResponseHeader("Last-Modified")) && (_.lastModified[o] = E),
                (E = x.getResponseHeader("etag")) && (_.etag[o] = E)),
                ...
                x.status = t,
                x.statusText = (n || T) + "",
                u ? v.resolveWith(g, [d, T, x]) : v.rejectWith(g, [x, T, h]),
                x.statusCode(b),
                b = void 0,
    ...
    _.ajaxPrefilter("json jsonp", function(t, n, i) {
        ...
        if (a || "jsonp" === t.dataTypes[0])
            ...
            a ? t[a] = t[a].replace(Kt, "$1" + r) : !1 !== t.jsonp && (t.url += (Et.test(t.url) ? "&" : "?") + t.jsonp + "=" + r),
    ...
    _.parseHTML = function(e, t, n) {
        ...
        o = N.exec(e),
        s = !n && [],
        o ? [t.createElement(o[1])] : (o = ye([e], t, s),
    ...
    _.offset = {
        setOffset: function(e, t, n) {
            var i, r, o, s, a, l, u = _.css(e, "position"), c = _(e), f = {};
...
function(e, t) {
    ...
    for (var o, s, a, l, u, c, f, d, h, p, g, m, v, y, b, w, _, E, T, x, C, S, A, D, N, I, O, k, L, j, P, H, q, M, R, W, F, B, U, V, K, Q, z, $, Y, G, X, J, Z, ee, te, ne, ie, re, oe, se, ae, le, ue, ce, fe, de, he, pe, ge = function(e) {
        ...
        i
    }(t = t && t.hasOwnProperty("default") ? t.default : t), me = (s = "alert",
    l = "." + (a = "bs.alert"),
    u = (o = t).fn[s],
    c = {
        CLOSE: "close" + l,
    ...
    I = function() {
        ...
        return t.toggle = function() {
            ...
            e && g(this._element).toggleClass(_)
        }
        ,
        t.dispose = function() {
    ...
    g(document).on(N.CLICK_DATA_API, x, function(e) {
        e.preventDefault();
        var t = e.target;
        g(t).hasClass(E) || (t = g(t).closest(D)),
        I._jQueryInterface.call(g(t), "toggle")
    ...
    J = function() {
        ...
        t.pause = function(e) {
            e || (this._isPaused = !0),
            this._element.querySelector(X.NEXT_PREV) && (ge.triggerTransitionEnd(this._element),
            this.cycle(!0)),
        ...
        t.to = function(e) {
            ...
            if (!(e > this._items.length - 1 || e < 0))
                if (this._isSliding)
                    O(this._element).one(U.SLID, function() {
                        return t.to(e)
                    });
                else {
                    if (n === e)
        ...
        t._slide = function(e, t) {
            var n, i, r, o = this, s = this._element.querySelector(X.ACTIVE_ITEM), a = this._getItemIndex(s), l = t || s && this._getItemByDirection(e, s), u = this._getItemIndex(l), c = Boolean(this._interval);
            if (e === R ? (n = $,
            i = Y,
            r = F) : (n = z,
            i = G,
            ...
            l && O(l).hasClass(K))
                ...
                if (O(this._element).hasClass(Q)) {
                    ...
                    O(s).one(ge.TRANSITION_END, function() {
                        O(l).removeClass(n + " " + i).addClass(K),
                        O(s).removeClass(K + " " + i + " " + n),
                        o._isSliding = !1,
                        setTimeout(function() {
    ...
    O(document).on(U.CLICK_DATA_API, X.DATA_SLIDE, J._dataApiClickHandler),
    ...
    O.fn[k] = J._jQueryInterface,
    O.fn[k].Constructor = J,
    O.fn[k].noConflict = function() {
        return O.fn[k] = H,
        J._jQueryInterface
    }
    ,
    ...
    pe = function() {
        function e(e, t) {
            ...
            this._element = e,
            this._config = this._getConfig(t),
            this._triggerArray = Z.makeArray(document.querySelectorAll('[data-toggle="collapse"][href="#' + e.id + '"],[data-toggle="collapse"][data-target="#' + e.id + '"]'));
        ...
        t.show = function() {
            ...
            !(t && (n = Z(t).not(this._selector).data(te)) && n._isTransitioning))) {
                var r = Z.Event(se.SHOW);
                if (Z(this._element).trigger(r),
                !r.isDefaultPrevented()) {
                    t && (e._jQueryInterface.call(Z(t).not(this._selector), "hide"),
                    n || Z(t).data(te, null));
                    var o = this._getDimension();
                    Z(this._element).removeClass(le).addClass(ue),
                    this._element.style[o] = 0,
                    this._triggerArray.length && Z(this._triggerArray).removeClass(ce).attr("aria-expanded", !0),
                    ...
                    Z(this._element).one(ge.TRANSITION_END, function() {
                        Z(i._element).removeClass(ue).addClass(le).addClass(ae),
                        i._element.style[o] = "",
                        i.setTransitioning(!1),
                        Z(i._element).trigger(se.SHOWN)
        ...
        t.hide = function() {
            ...
            if (!this._isTransitioning && Z(this._element).hasClass(ae)) {
                ...
                if (Z(this._element).trigger(t),
                !t.isDefaultPrevented()) {
                    var n = this._getDimension();
                    this._element.style[n] = this._element.getBoundingClientRect()[n] + "px",
                    ge.reflow(this._element),
                    Z(this._element).addClass(ue).removeClass(le).removeClass(ae);
                    ...
                    if (i > 0)
                        for (var r = 0; r < i; r++) {
                            var o = this._triggerArray[r]
                              , s = ge.getSelectorFromElement(o);
                            if (null !== s)
                                Z([].slice.call(document.querySelectorAll(s))).hasClass(ae) || Z(o).addClass(ce).attr("aria-expanded", !1)
                        }
                    this.setTransitioning(!0);
                    ...
                    Z(this._element).one(ge.TRANSITION_END, function() {
                        ...
                        Z(e._element).removeClass(ue).addClass(le).trigger(se.HIDDEN)
                    }).emulateTransitionEnd(a)
                }
            }
        }
        ...
        ,
        t._getConfig = function(e) {
            return (e = r({}, re, e)).toggle = Boolean(e.toggle),
            ge.typeCheckConfig(ee, e, oe),
            e
        }
        ,
        ...
        t._getParent = function() {
            var t = this
              , n = null;
            ge.isElement(this._config.parent) ? (n = this._config.parent,
    ...
    Z.fn[ee] = pe._jQueryInterface,
    Z.fn[ee].Constructor = pe,
    Z.fn[ee].noConflict = function() {
        return Z.fn[ee] = ie,
        pe._jQueryInterface
    }
    ,
    ...
    function ke(e) {
        ...
        for (var t = Oe(10) ? document.body : null, n = e.offsetParent; n === t && e.nextElementSibling; )
    ...
    function je(e, t) {
        ...
        if (e !== l && t !== l || i.contains(r))
            return "BODY" === (a = (s = l).nodeName) || "HTML" !== a && ke(s.firstElementChild) !== s ? ke(l) : l;
        var u = Le(e);
    ...
    function et(e, t, n) {
        return (void 0 === n ? e : e.slice(0, function(e, t, n) {
            ...
            e.enabled && Ce(n) && (t.offsets.popper = Ue(t.offsets.popper),
            t.offsets.reference = Ue(t.offsets.reference),
            t = n(t, e))
        }),
        t
    }
    ...
    function at(e, t) {
        Object.keys(t).forEach(function(n) {
            var i = "";
            -1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(n) && st(t[n]) && (i = "px"),
            e.style[n] = t[n] + i
        })
    }
    function lt(e, t, n) {
    ...
    var pt = {
        ...
        modifiers: {
            ...
            arrow: {
                ...
                fn: function(e, t) {
                    var n;
                    if (!lt(e.instance.modifiers, "arrow", "keepTogether"))
                        return e;
                    var i = t.element;
                    if ("string" == typeof i) {
                    ...
                    e.offsets.popper = Ue(e.offsets.popper);
                    var g = a[f] + a[u] / 2 - p / 2
            ...
            flip: {
                ...
                enabled: !0,
                fn: function(e, t) {
                    if (tt(e.instance.modifiers, "inner"))
                        return e;
                    ...
                    return s.forEach(function(a, l) {
                        ...
                        i = e.placement.split("-")[0],
                        r = Xe(i);
                        var u, c = e.offsets.popper, f = e.offsets.reference, d = Math.floor, h = "left" === i && d(c.right) > d(f.left) || "right" === i && d(c.left) < d(f.right) || "top" === i && d(c.bottom) > d(f.top) || "bottom" === i && d(c.top) < d(f.bottom), p = d(c.left) < d(n.left), g = d(c.right) > d(n.right), m = d(c.top) < d(n.top), v = d(c.bottom) > d(n.bottom), y = "left" === i && p || "right" === i && g || "top" === i && m || "bottom" === i && v, b = -1 !== ["top", "bottom"].indexOf(i), w = !!t.flipVariations && (b && "start" === o && p || b && "end" === o && g || !b && "start" === o && m || !b && "end" === o && v);
                        (h || y || w) && (e.flipped = !0,
                        (h || y) && (i = s[l + 1]),
                        w && (o = "end" === (u = o) ? "start" : "start" === u ? "end" : u),
                        e.placement = i + (o ? "-" + o : ""),
                        e.offsets.popper = Be({}, e.offsets.popper, Je(e.instance.popper, e.offsets.reference, e.placement)),
                        e = et(e.instance.modifiers, e, "flip"))
                    }),
                    e
                },
                behavior: "flip",
            ...
            hide: {
                ...
                enabled: !0,
                fn: function(e) {
                    if (!lt(e.instance.modifiers, "hide", "preventOverflow"))
                        return e;
            ...
            computeStyle: {
                ...
                fn: function(e, t) {
                    ...
                    var s = void 0 !== o ? o : t.gpuAcceleration
                      ...
                      , h = void 0
                      , p = void 0;
                    if (p = "bottom" === c ? -a.height + u.bottom : u.top,
                    h = "right" === f ? -a.width + u.right : u.left,
                    s && d)
                        l[d] = "translate3d(" + h + "px, " + p + "px, 0)",
                        l[c] = 0,
                        l[f] = 0,
                    ...
                    return e.attributes = Be({}, v, e.attributes),
            ...
            applyStyle: {
                ...
                fn: function(e) {
                    var t, n;
                    return at(e.instance.popper, e.styles),
                    t = e.instance.popper,
                    n = e.attributes,
                    Object.keys(n).forEach(function(e) {
                        !1 !== n[e] ? t.setAttribute(e, n[e]) : t.removeAttribute(e)
                    }),
                    e.arrowElement && Object.keys(e.arrowStyles).length && at(e.arrowElement, e.arrowStyles),
                    e
                },
      ...
      , gt = function() {
        function e(t, n) {
            ...
            Object.keys(Be({}, e.Defaults.modifiers, r.modifiers)).forEach(function(t) {
        ...
        return We(e, [{
            ...
            value: function() {
                return function() {
                    if (!this.state.isDestroyed) {
                        ...
                        e.offsets.reference = Ye(this.state, this.popper, this.reference, this.options.positionFixed),
            ...
            value: function() {
                return function() {
                    ...
                    tt(this.modifiers, "applyStyle") && (this.popper.removeAttribute("x-placement"),
    ...
    Vt = function() {
                ...
                !n) {
                    ...
                    !r.isDefaultPrevented()) {
                        if (!this._inNavbar) {
                            ...
                            var o = this._element;
                            "parent" === this._config.reference ? o = t : ge.isElement(this._config.reference) && (o = this._config.reference,
                            void 0 !== this._config.reference.jquery && (o = this._config.reference[0])),
                            "scrollParent" !== this._config.boundary && mt(t).addClass(It),
                        ...
                        mt(this._menu).toggleClass(Ct),
                        mt(t).toggleClass(Ct).trigger(mt.Event(Tt.SHOWN, i))
                    }
                }
            }
        }
        ,
        t.dispose = function() {
            mt.removeData(this._element, yt),
        ...
        ,
        t._getConfig = function(e) {
            return e = r({}, this.constructor.Default, mt(this._element).data(), e),
            ge.typeCheckConfig(vt, e, this.constructor.DefaultType),
            e
        }
        ,
        ...
        t._getPlacement = function() {
            var e = mt(this._element.parentNode)
              , t = Mt;
            return e.hasClass(St) ? (t = Ht,
            mt(this._menu).hasClass(Nt) && (t = qt)) : e.hasClass(At) ? t = Wt : e.hasClass(Dt) ? t = Ft : mt(this._menu).hasClass(Nt) && (t = Rt),
            t
        }
        ,
        ...
        t._getPopperConfig = function() {
            ...
            "function" == typeof this._config.offset ? t.fn = function(t) {
                return t.offsets = r({}, t.offsets, e._config.offset(t.offsets) || {}),
                t
            }
                ...
                for (var n = [].slice.call(document.querySelectorAll(Ot)), i = 0, r = n.length; i < r; i++) {
                    ...
                    s) {
                        ...
                        if (mt(o).hasClass(Ct) && !(t && ("click" === t.type && /input|textarea/i.test(t.target.tagName) || "keyup" === t.type && 9 === t.which) && mt.contains(o, t.target))) {
                            ...
                            mt(o).trigger(u),
                            u.isDefaultPrevented() || ("ontouchstart"in document.documentElement && mt(document.body).children().off("mouseover", null, mt.noop),
                            n[i].setAttribute("aria-expanded", "false"),
                            mt(l).removeClass(Ct),
                            mt(o).removeClass(Ct).trigger(mt.Event(Tt.HIDDEN, a)))
                        }
                    }
                }
        }
        ...
        e._dataApiKeydownHandler = function(t) {
            if ((/input|textarea/i.test(t.target.tagName) ? !(32 === t.which || 27 !== t.which && (40 !== t.which && 38 !== t.which || mt(t.target).closest(Lt).length)) : Et.test(t.which)) && (t.preventDefault(),
            t.stopPropagation(),
            !this.disabled && !mt(this).hasClass(xt))) {
    ...
    mt(document).on(Tt.KEYDOWN_DATA_API, Ot, Vt._dataApiKeydownHandler).on(Tt.KEYDOWN_DATA_API, Lt, Vt._dataApiKeydownHandler).on(Tt.CLICK_DATA_API + " " + Tt.KEYUP_DATA_API, Vt._clearMenus).on(Tt.CLICK_DATA_API, Ot, function(e) {
        e.preventDefault(),
        e.stopPropagation(),
        Vt._jQueryInterface.call(mt(this), "toggle")
    }).on(Tt.CLICK_DATA_API, kt, function(e) {
        e.stopPropagation()
    }),
    mt.fn[vt] = Vt._jQueryInterface,
    mt.fn[vt].Constructor = Vt,
    ...
    sn = function() {
        function e(e, t) {
            this._config = this._getConfig(t),
            this._element = e,
            this._dialog = e.querySelector(on.DIALOG),
            this._backdrop = null,
            this._isShown = !1,
        ...
        t.show = function(e) {
            ...
            if (!this._isTransitioning && !this._isShown) {
                ...
                Kt(this._element).trigger(n),
                this._isShown || n.isDefaultPrevented() || (this._isShown = !0,
                this._checkScrollbar(),
                this._setScrollbar(),
                this._adjustDialog(),
                Kt(document.body).addClass(tn),
                this._setEscapeEvent(),
                this._setResizeEvent(),
                Kt(this._element).on(Jt.CLICK_DISMISS, on.DATA_DISMISS, function(e) {
                    return t.hide(e)
                }),
        ...
        t.hide = function(e) {
            ...
            !this._isTransitioning && this._isShown) {
                ...
                this._isShown && !n.isDefaultPrevented()) {
                    ...
                    this._setEscapeEvent(),
                    this._setResizeEvent(),
                    Kt(document).off(Jt.FOCUSIN),
                    Kt(this._element).removeClass(rn),
                    Kt(this._element).off(Jt.CLICK_DISMISS),
                    Kt(this._dialog).off(Jt.MOUSEDOWN_DISMISS),
                    i) {
        ...
        ,
        t.dispose = function() {
            Kt.removeData(this._element, zt),
            Kt(window, document, this._element, this._backdrop).off($t),
            this._config = null,
            this._element = null,
            this._dialog = null,
            this._backdrop = null,
        ...
        t._hideModal = function() {
            ...
            this._isTransitioning = !1,
            this._showBackdrop(function() {
                Kt(document.body).removeClass(tn),
                e._resetAdjustments(),
                e._resetScrollbar(),
                Kt(e._element).trigger(Jt.HIDDEN)
            })
        }
        ,
        t._removeBackdrop = function() {
            this._backdrop && (Kt(this._backdrop).remove(),
            this._backdrop = null)
        }
        ,
        t._showBackdrop = function(e) {
            ...
            if (this._isShown && this._config.backdrop) {
                ...
                Kt(this._element).on(Jt.CLICK_DISMISS, function(e) {
                    t._ignoreBackdropClick ? t._ignoreBackdropClick = !1 : e.target === e.currentTarget && ("static" === t._config.backdrop ? t._element.focus() : t.hide())
                }),
                n && ge.reflow(this._backdrop),
                Kt(this._backdrop).addClass(rn),
                !e)
                    return;
                if (!n)
                    return void e();
        ...
        t._resetScrollbar = function() {
            ...
            Kt(document.body).removeData("padding-right"),
    ...
    Kt(document).on(Jt.CLICK_DATA_API, on.DATA_TOGGLE, function(e) {
        var t, n = this, i = ge.getSelectorFromElement(this);
    ...
    Kt.fn[Qt] = sn._jQueryInterface,
    Kt.fn[Qt].Constructor = sn,
    Kt.fn[Qt].noConflict = function() {
        return Kt.fn[Qt] = Yt,
        sn._jQueryInterface
    }
    ,
    ...
    Dn = function() {
        ...
        t.toggle = function(e) {
            if (this._isEnabled)
                if (e) {
                    ...
                    if (an(this.getTipElement()).hasClass(_n))
        ...
        t.show = function() {
            ...
            if (this.isWithContent() && this._isEnabled) {
                ...
                this.setContent(),
                this.config.animation && an(i).addClass(wn);
                ...
                this._popper = new gt(this.element,i,{
                    placement: s,
                    modifiers: {
                        offset: {
        ...
        t.hide = function(e) {
            var t = this
              ...
              , r = function() {
                t._hoverState !== vn && n.parentNode && n.parentNode.removeChild(n),
                t._cleanTipClass(),
                t.element.removeAttribute("aria-describedby"),
                an(t.element).trigger(t.constructor.Event.HIDDEN),
                null !== t._popper && t._popper.destroy(),
                e && e()
            };
            if (an(this.element).trigger(i),
            !i.isDefaultPrevented()) {
                if (an(n).removeClass(_n),
        ...
        t.setContent = function() {
            ...
            this.setElementContent(an(e.querySelectorAll(En)), this.getTitle()),
            an(e).removeClass(wn + " " + _n)
        }
        ,
        ...
        t._setListeners = function() {
            ...
            this.config.trigger.split(" ").forEach(function(t) {
                if ("click" === t)
                    an(e.element).on(e.constructor.Event.CLICK, e.config.selector, function(t) {
                        return e.toggle(t)
                    });
                else if (t !== An) {
        ...
        t._enter = function(e, t) {
            ...
            (t = t || an(e.currentTarget).data(n)) || (t = new this.constructor(e.currentTarget,this._getDelegateConfig()),
            an(e.currentTarget).data(n, t)),
            e && (t._activeTrigger["focusin" === e.type ? Cn : xn] = !0),
            an(t.getTipElement()).hasClass(_n) || t._hoverState === vn ? t._hoverState = vn : (clearTimeout(t._timeout),
            t._hoverState = vn,
        ...
        t._leave = function(e, t) {
            ...
            (t = t || an(e.currentTarget).data(n)) || (t = new this.constructor(e.currentTarget,this._getDelegateConfig()),
            an(e.currentTarget).data(n, t)),
            e && (t._activeTrigger["focusout" === e.type ? Cn : xn] = !1),
        ...
        t._getConfig = function(e) {
            ...
            ge.typeCheckConfig(ln, e, this.constructor.DefaultType),
            e
        }
        ,
        ...
        t._fixTransition = function() {
            ...
            null === e.getAttribute("x-placement") && (an(e).removeClass(wn),
    ...
    Un = function(e) {
        ...
        o.getTipElement = function() {
            return this.tip = this.tip || Nn(this.config.template)[0],
            this.tip
        }
        ,
        o.setContent = function() {
            ...
            this.setElementContent(e.find(Fn), t),
            e.removeClass(Mn + " " + Rn)
        }
        ,
        ...
        r._jQueryInterface = function(e) {
            return this.each(function() {
                ...
                if ((t || !/destroy|hide/.test(e)) && (t || (t = new r(this,n),
                Nn(this).data(On, t)),
                "string" == typeof e)) {
                    if (void 0 === t[e])
    ...
    Nn.fn[In] = Un._jQueryInterface,
    Nn.fn[In].Constructor = Un,
    Nn.fn[In].noConflict = function() {
        return Nn.fn[In] = Ln,
        Un._jQueryInterface
    }
    ,
    ...
    ii = function() {
        function e(e, t) {
            ...
            this._config = this._getConfig(t),
            this._selector = this._config.target + " " + ei.NAV_LINKS + "," + this._config.target + " " + ei.LIST_ITEMS + "," + this._config.target + " " + ei.DROPDOWN_ITEMS,
            this._offsets = [],
            this._targets = [],
            this._activeTarget = null,
            this._scrollHeight = 0,
            Vn(this._scrollElement).on(Xn.SCROLL, function(e) {
                return n._process(e)
            }),
            this.refresh(),
            this._process()
        ...
        ,
        t.dispose = function() {
            Vn.removeData(this._element, Qn),
            Vn(this._scrollElement).off(zn),
            this._element = null,
        ...
        t._getConfig = function(e) {
            if ("string" != typeof (e = r({}, Yn, "object" == typeof e && e ? e : {})).target) {
                ...
                t || (t = ge.getUID(Kn),
                Vn(e.target).attr("id", t)),
                e.target = "#" + t
            }
            return ge.typeCheckConfig(Kn, e, Gn),
            e
        }
        ,
        ...
        t._activate = function(e) {
            ...
            n.hasClass(Jn) ? (n.closest(ei.DROPDOWN).find(ei.DROPDOWN_TOGGLE).addClass(Zn),
            n.addClass(Zn)) : (n.addClass(Zn),
            n.parents(ei.NAV_LIST_GROUP).prev(ei.NAV_LINKS + ", " + ei.LIST_ITEMS).addClass(Zn),
            n.parents(ei.NAV_LIST_GROUP).prev(ei.NAV_ITEMS).children(ei.NAV_LINKS).addClass(Zn)),
            Vn(this._scrollElement).trigger(Xn.ACTIVATE, {
                relatedTarget: e
            })
        }
        ,
    ...
    Vn.fn[Kn] = ii._jQueryInterface,
    Vn.fn[Kn].Constructor = ii,
    Vn.fn[Kn].noConflict = function() {
        return Vn.fn[Kn] = $n,
        ii._jQueryInterface
    }
    ,
    ...
    _i = function() {
        ...
        return t.show = function() {
            ...
            if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && ri(this._element).hasClass(ci) || ri(this._element).hasClass(fi))) {
                var t, n, i = ri(this._element).closest(gi)[0], r = ge.getSelectorFromElement(this._element);
                if (i) {
        ...
        t._transitionComplete = function(e, t, n) {
            ...
            ge.reflow(e),
            ri(e).addClass(hi),
            e.parentNode && ri(e.parentNode).hasClass(ui)) {
    ...
    ri(document).on(li.CLICK_DATA_API, yi, function(e) {
        e.preventDefault(),
        _i._jQueryInterface.call(ri(this), "show")
    }),
    ri.fn.tab = _i._jQueryInterface,
    ri.fn.tab.Constructor = _i,
...
function(e) {
    e.fn.extend({
        slimScroll: function(n) {
            ...
            return this.each(function() {
                var r, o, s, a, l, u, c, f, d = "<div></div>", h = 30, p = !1, g = e(this);
                if (g.parent().hasClass(i.wrapperClass)) {
                    var m = g.scrollTop();
                    if (E = g.siblings("." + i.barClass),
                    _ = g.siblings("." + i.railClass),
                    S(),
                    e.isPlainObject(n)) {
                        ...
                        if ("scrollTo"in n)
                            m = parseInt(i.scrollTo);
                        else if ("scrollBy"in n)
                            m += parseInt(i.scrollBy);
                    ...
                    g.parent().append(E),
                    g.parent().append(_),
                    i.railDraggable && E.bind("mousedown", function(n) {
                        var i = e(document);
                        return s = !0,
                    ...
                    g.bind("touchmove", function(e) {
                        ...
                        e.originalEvent.touches.length) && (C((l - e.originalEvent.touches[0].pageY) / i.touchScrollStep, !0),
                        l = e.originalEvent.touches[0].pageY)
                    }),
                    S(),
                    "bottom" === i.start ? (E.css({
                        top: g.outerHeight() - E.outerHeight()
                    }),
                    C(0, !0)) : "top" !== i.start && (C(e(i.start).position().top, null, !0),
                    i.alwaysVisible || E.hide()),
                    w = this,
                    window.addEventListener ? (w.addEventListener("DOMMouseScroll", x, !1),
                    w.addEventListener("mousewheel", x, !1)) : document.attachEvent("onmousewheel", x)
                }
                function x(t) {
                    if (r) {
                        var n = 0;
                        ...
                        e(o).closest("." + i.wrapperClass).is(g.parent()) && C(n, !0),
                ...
                function C(e, t, n) {
                    ...
                    if (t && (r = parseInt(E.css("top")) + e * parseInt(i.wheelStep) / 100 * E.outerHeight(),
                    r = Math.min(Math.max(r, 0), o),
                    r = e > 0 ? Math.ceil(r) : Math.floor(r),
                    E.css({
                        top: r + "px"
                    })),
                    r = (c = parseInt(E.css("top")) / (g.outerHeight() - E.outerHeight())) * (g[0].scrollHeight - g.outerHeight()),
                    n) {
                ...
                function S() {
                    u = Math.max(g.outerHeight() / g[0].scrollHeight * g.outerHeight(), h),
                    E.css({
                        height: u + "px"
                    });
                ...
                function A() {
                    ...
                    c == ~~c) {
                        ...
                        p = !1;
                    f = c,
                    u >= g.outerHeight() ? p = !0 : (E.stop(!0, !0).fadeIn("fast"),
                    i.railVisible && _.stop(!0, !0).fadeIn("fast"))
                }
                function D() {
                    i.alwaysVisible || (a = setTimeout(function() {
                        i.disableFadeOut && r || o || s || (E.fadeOut("slow"),
                        _.fadeOut("slow"))
                    }, 1e3))
                }
            }),
...
function(e, t) {
    ...
    u = function() {
        ...
        return i.init = function() {
            var e = this
              , t = this.config;
            n(this.element).find(t.parentTrigger + "." + t.activeClass).has(t.subMenu).children(t.subMenu).attr("aria-expanded", !0).addClass(t.collapseClass + " " + t.collapseInClass),
            n(this.element).find(t.parentTrigger).not("." + t.activeClass).has(t.subMenu).children(t.subMenu).attr("aria-expanded", !1).addClass(t.collapseClass),
            n(this.element).find(t.parentTrigger).has(t.subMenu).children(t.triggerElement).on(l.CLICK_DATA_API, function(i) {
                var r = n(this)
                ...
                "true" !== r.attr("aria-disabled") && (o.hasClass(t.activeClass) ? (r.attr("aria-expanded", !1),
                e.hide(a)) : (e.show(a),
                r.attr("aria-expanded", !0),
                t.toggle && s.attr("aria-expanded", !1)),
        ...
        i.show = function(e) {
            ...
            if (!this.transitioning && !n(e).hasClass(this.config.collapsingClass)) {
                ...
                !r.isDefaultPrevented()) {
                    ...
                    this.setTransitioning(!0);
                    var o = function() {
                        t.config && t.element && (i.removeClass(t.config.collapsingClass).addClass(t.config.collapseClass + " " + t.config.collapseInClass).height("").attr("aria-expanded", !0),
            ...
            if (!this.transitioning && n(e).hasClass(this.config.collapseInClass)) {
                ...
                !r.isDefaultPrevented()) {
                    ...
                    var o = function() {
                        ...
                        t.setTransitioning(!1),
                        i.trigger(l.HIDDEN),
                        i.removeClass(t.config.collapsingClass).addClass(t.config.collapseClass).attr("aria-expanded", !1))
                    };
        ...
        e.jQueryInterface = function(i) {
            return this.each(function() {
                ...
                if (!s && /dispose/.test(i) && this.dispose(),
                s || (s = new e(this,l),
                o.data(r, s)),
                "string" == typeof i) {
                    if (void 0 === s[i])
...
function(e, t) {
    ...
    var f = {
        ...
        allowEvent: function(e) {
            var t = !0;
            return /^(mousedown|mousemove)$/.test(e.type) && f.touches && (t = !1),
            t
        },
    ...
    return e.init = function(e) {
        ...
        i && (t.addEventListener("touchstart", d, !1),
        t.addEventListener("touchcancel", f.registerEvent, !1),
        t.addEventListener("touchend", f.registerEvent, !1)),
    ...
    t.prototype.refresh = function() {
        ...
        e = {
            ...
            for (var a in this.waypoints[o]) {
                var l, u, c, f, d = this.waypoints[o][a], h = d.options.offset, p = d.triggerPoint, g = 0, m = null == p;
                ...
                f = !u && !c,
                !m && (u && c) ? (d.queueTrigger(s.backward),
                i[d.group.id] = d.group) : !m && f ? (d.queueTrigger(s.forward),
            ...
            t.waypoint(function(o) {
                !function() {
                    ...
                    t.data("counterup-func", function() {
                        ...
                        t.data("counterup-nums").length ? setTimeout(t.data("counterup-func"), r.delay) : (t.data("counterup-nums", null),

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="SchoolApp.imports.Dashboard" %>
...
<body class="skin-black-light sidebar-mini">
    <div class="wrapper">
            ...
            <nav class="navbar navbar-static-top">
                ...
                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav pull-right">
                        <li id="schoolInfo"><b><i class="fa fa-building"></i> School Name</b></li>
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-footer">
                                    <div class="pull-left">
                                        <a href="/user/my-profile" class="btn btn-default">Profile</a>
                                    </div>
                                    <div class="pull-right">
                                        <a href="/site/logout" data-method="post" class="btn btn-default">Sign Out</a>
                                    </div>
                                </li>
                            </ul>
                        </li>
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="treeview" id="school-management">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="school/infrastructure"><i class="fa fa-building"></i> Infrastructure</a></li>
                            <li><a href="school/departments"><i class="fa fa-sitemap"></i> Manage Departments</a></li>
                            <li><a href="school/clubs-societies"><i class="fa fa-users"></i> Clubs & Societies</a></li>
                            <li><a href="school/timetables"><i class="fa fa-clock"></i> School Timetables</a></li>
                            <li><a href="school/calendar"><i class="fa fa-calendar-alt"></i> School Calendar</a></li>
                            <li><a href="school/announcements"><i class="fa fa-bullhorn"></i> Announcements</a></li>
                            <li><a href="school/policies"><i class="fa fa-book"></i> School Policies</a></li>
                            <li><a href="school/alumni"><i class="fa fa-graduation-cap"></i> Alumni Management</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="treeview" id="student-management">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="student/profiles"><i class="fa fa-id-card"></i> Student Profiles</a></li>
                            <li><a href="student/enrollment"><i class="fa fa-user-plus"></i> Enrollment & Admission</a></li>
                            <li><a href="student/attendance"><i class="fa fa-calendar-check"></i> Attendance Tracking</a></li>
                            <li><a href="student/performance"><i class="fa fa-chart-line"></i> Academic Performance</a></li>
                            <li><a href="student/discipline-records"><i class="fa fa-gavel"></i> Discipline Records</a></li>
                            <li><a href="student/health"><i class="fa fa-medkit"></i> Health Records</a></li>
                            <li><a href="student/guardian-info"><i class="fa fa-users"></i> Guardian Information</a></li>
                            <li><a href="student/transcripts"><i class="fa fa-file-alt"></i> Transcripts & Report Cards</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="treeview" id="academics-management">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="academics/classes"><i class="fa fa-users"></i> Manage Classes</a></li>
                            <li><a href="academics/terms"><i class="fa fa-calendar"></i> Manage Terms</a></li>
                            <li><a href="academics/subjects"><i class="fa fa-book"></i> Manage Subjects</a></li>
                            <li><a href="academics/exams"><i class="fa fa-file-text"></i> Manage Exams</a></li>
                            <li><a href="academics/results"><i class="fa fa-check"></i> Manage Results</a></li>
                    ...
                    <li class="treeview" id="administration-management">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="administration/attendance-records"><i class="fa fa-calendar-check"></i> Attendance Records</a></li>
                            <li><a href="administration/inventory"><i class="fa fa-boxes"></i> Inventory Management</a></li>
                            <li><a href="administration/transport"><i class="fa fa-bus"></i> Transport Management</a></li>
                            <li><a href="administration/hostel-management"><i class="fa fa-bed"></i> Hostel Management</a></li>
                            <li><a href="administration/discipline"><i class="fa fa-gavel"></i> Discipline Management</a></li>
                            <li><a href="administration/library"><i class="fa fa-book"></i> Library Management</a></li>
                            <li><a href="administration/events"><i class="fa fa-calendar-alt"></i> Event Management</a></li>
                            <li><a href="administration/reports"><i class="fa fa-chart-line"></i> Generate Reports</a></li>
                        </ul>
                    </li>
                    <!-- Message Center Module with Badge for New Messages -->
                        <li class="treeview" id="message-center">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="messages/sent"><i class="fa fa-paper-plane"></i> Sent Messages</a></li>
                                <li><a href="messages/drafts"><i class="fa fa-file"></i> Drafts</a></li>
                                <li><a href="messages/compose"><i class="fa fa-edit"></i> Compose Message</a></li>
                                <li><a href="messages/archived"><i class="fa fa-archive"></i> Archived Messages</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="treeview" id="notice-board">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="notices/view"><i class="fa fa-eye"></i> View Notices</a></li>
                                <li><a href="notices/create"><i class="fa fa-plus"></i> Create Notice</a></li>
                                <li><a href="notices/manage"><i class="fa fa-edit"></i> Manage Notices</a></li>
                                <li><a href="notices/categories"><i class="fa fa-tags"></i> Notice Categories</a></li>
                                <li><a href="notices/archived"><i class="fa fa-archive"></i> Archived Notices</a></li>
                            </ul>
                        </li>
        ...
        <div class="container-fluid">
            <h1>Welcome, <span>User Role</span></h1>
            ...
            <div class="row">
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box bg-aqua">
                        <div class="inner">
                            <h3 id="newEnrollments">0</h3> <!-- Dynamic -->
                            <p>New Enrollments</p>
                        </div>
                        <div class="icon">
                ...
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box bg-yellow">
                        <div class="inner">
                            <h3 id="parentsRegistered">30</h3> <!-- Dynamic -->
                ...
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box bg-red">
                        <div class="inner">
                            <h3 id="pendingAdmissions">20</h3> <!-- Dynamic -->
                ...
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box bg-info">
                        <div class="inner">
                            <h3 id="totalStudents">250</h3> <!-- Dynamic -->
                            <p>Total Students</p>
                        </div>
                        <div class="icon">
                ...
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box bg-purple">
                        <div class="inner">
                            <h3 id="totalTeachers">40</h3> <!-- Dynamic -->
                            <p>Total Teachers</p>
                        </div>
                        <div class="icon">
            ...
            <!-- Financial Cards -->
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box bg-success">
                        <div class="inner">
                            <h3 id="amountCollected">UGX 10,000</h3> <!-- Dynamic -->
                ...
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box bg-warning">
                        <div class="inner">
                            <h3 id="amountExpected">UGX 15,000</h3> <!-- Dynamic -->
                            <p>Amount Expected</p>
                        </div>
                        <div class="icon">
                ...
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box bg-danger">
                        <div class="inner">
                            <h3 id="amountUnpaid">UGX 5,000</h3> <!-- Dynamic -->
                            <p>Amount Unpaid</p>
                        </div>
                        <div class="icon">
